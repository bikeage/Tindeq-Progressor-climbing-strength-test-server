...
class CFT:
    ...
    def make_login(self, doc):
        ...
        self.layout=column(column(div_image),column(password,button))
...
# '''.format( self.max_left,self.max_right,self.cf_peak_load,self.cf_critical_load,self.cf_percent)
        ...
        self.text_input_bw = TextInput(value="", title="Enter body weight in kg for further analysis")
    ...
    def check_for_timeout(self):
        self.seconds_left = (60*60) - (time.time() - self.timout_t0 )
